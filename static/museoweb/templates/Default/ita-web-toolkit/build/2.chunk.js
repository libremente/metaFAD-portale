...
(function (factory) {
	...
	(function () {
		...
		ColumnToggle.prototype.init = function () {
			...
			$menuButton = $("<a href='#" + id + "' class='btn tablesaw-btn btn-micro " + this.classes.columnBtn + "' data-popup-link>" + "<span>" + Tablesaw.i18n.columnBtnText + "</span></a>");
