                ...
                <header id="header" class="bg-eee fixed-header clearfix init-scroll">
                	...
                	<div class="content clearfix">
                        ...
                        <div class="mcp-module-results-tool clearfix">
                            ...
                            <!-- module-column -->
                            <!--
                            <div id="searchOptions" class="module-column pull-right padding-right">
                                <div class="bcp-count-results">
                                    <ul class="bcp-result-filter-list bcp-result-filter-list--tool">
                                        <li><a href="javascript:void(0)">Seleziona tutti</a></li>
                                        <li><a href="javascript:void(0)">Visualizza tutti</a></li>
                                        <li><a href="javascript:void(0)">Stampa</a></li>
                                        <li><a href="javascript:void(0)">Salva ricerca</a></li>
                                        <li><a href="javascript:void(0)">Invia email</a></li>
                                    </ul>
                                </div>
                            </div>
                            -->
